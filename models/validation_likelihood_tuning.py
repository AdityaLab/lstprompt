...
def get_autotuned_predictions_data(train, test, hypers, num_samples, get_predictions_fn, verbose=False, parallel=True, n_train=None, n_val=None,prompt_method="LSTP",all_time_steps=-1,breath_steps=-1,dataname="NA"):
    """
    ...
    out = get_predictions_fn(train, test, **best_hyper, num_samples=num_samples, n_train=n_train, parallel=parallel,prompt_method=prompt_method,all_time_steps=all_time_steps,breath_steps=breath_steps,dataname=dataname)
